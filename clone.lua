...
BuildABoat.Block = function(Block)
    ...
    return setmetatable({
		...
		Clone = function(self)
			...
			Trowel:InvokeServer({self.Object.Parent}, self.Object.CFrame, Zone.CFrame * Position, "Clone")
		
			repeat task.wait() until Block ~= nil
		
			Connection:Disconnect()
			
			local Block = BuildABoat.Block(Block)
			Block.CFrame = self.Object.CFrame
